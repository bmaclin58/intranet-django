...
def attachment_field () :
	return Field.file (
			...
			help_text = f'Screenshots or documents. Up to {settings.HELPDESK_MAX_FILES} files, '
                        f'{settings.HELPDESK_MAX_FILE_SIZE // (1024 * 1024)} MB each.',
			)
