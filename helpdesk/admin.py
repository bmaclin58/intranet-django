...
@admin.register(ApprovedSoftware)
class SoftwareApproval_Admin(ModelAdmin):
...
class TicketTypeAdmin(ModelAdmin):
    ...
    def preview_link(self, obj):
        ...
        return format_html('<a href="{}">Preview saved form</a>',
                           reverse('admin:helpdesk_tickettype_preview',
                                   args=[obj.pk]))
